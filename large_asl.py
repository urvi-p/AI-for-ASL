...
train_set = datasets.ImageFolder("alphabet_train", transform = transformations)
train_loader = torch.utils.data.DataLoader(train_set, batch_size=32, shuffle=True)

# val_set = datasets.ImageFolder("./asl_alphabet_test", transform = transformations)
# train_loader=torch.utils.data.DataLoader(train_set, batch_size=32, shuffle=True)

# #trainset = torchvision.datasets.(root='./data', train=True,
